...
geradeweg_1 :: Value
geradeweg_1 = packLines $ [".....    ", ".211.", "..2..  ", "3...4", "....."]

geradeweg_1_sol :: Value
geradeweg_1_sol = packLines $ ["┌┐┌─┐", "││└┐│  ", "│└─┘│", "└──┐│", "  .└┘ "]

tightfit_1 :: Value
tightfit_1 = packLines $ [" --- ", "3/\\.-", "-\\.\\4", "-.\\/-", " 35-"]
...
tightfit_broken_2 = packLines $ ["3/\\.-", "-\\x\\4", "-.\\/-", " 35-"]

tightfit_1_sol :: Value
tightfit_1_sol =
  packLines $ ["2/1 4\\5  3", "  4\\5  3  2\\1 ", "   3  1\\2 5/4"]
...
kpyramid_1 :: Value
kpyramid_1 =
  packLines $ ["G     3", "G    . .", "G   . . .", "W  .o. . .", "G 1*.*.o.*6"]

kpyramid_1_sol :: Value
kpyramid_1_sol =
  packLines $ ["    3", "   8 5", "  1 9 4", " 3 2 7 3", "1 2 4 3 6"]
...
compass_broken_1 =
  decodeLines $ ["grid: |", "  a.b", "clues:", "  b: 21 . . 0"]

compass_broken_2 :: Value
compass_broken_2 =
  decodeLines $ ["grid: |", "  a.b", "clues:", "  a: x . . 0", "  b: 21 . . 0"]

compass_broken_3 :: Value
compass_broken_3 =
  decodeLines $ ["grid: |", "  a.b", "clues:", "  a: 1 . .", "  b: 21 . . 0"]
...
thermo_1 :: Value
thermo_1 =
  packLines $ [".b..2.", "a.c5.1", ".d..6.", ".4..c.", "5.3b.d", ".2..a."]

thermo_2 :: Value
thermo_2 =
  packLines $ ["....2.", "..c5.1", ".b..6.", "a..c..", "a...b.", ".bc.a."]

thermo_broken_1 :: Value
thermo_broken_1 = packLines $ ["..", "a."]

thermo_broken_2 :: Value
thermo_broken_2 = packLines $ ["bb", "a."]
